...
private:
    ...
    static stTransferLogRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        TransferLogRecord.sAcct = vTransferLogRecord[1];
        TransferLogRecord.dAcct= vTransferLogRecord[2];
        TransferLogRecord.Amount= stof(vTransferLogRecord[3]);
        TransferLogRecord.sBalance= stof(vTransferLogRecord[4]);
        TransferLogRecord.sBalance = stof(vTransferLogRecord[5]);
...
public:
    ...
    struct stTransferLogRecord {
        ...
        string sAcct, dAcct;
        float Amount, sBalance, dBalance;
        string username;
    };
